...
const generateItemElement = function (item) {
  ...
  if (!item.checked) {
    itemTitle = `
<input class="js-item-edit" name="js-item-edit" type="text" value="${item.name}">
    `;
  }
...
// // Responsible for handling the click event edit button
// const handleEditItemClicked = function () {
//   // use event delegation
//   $(".js-shopping-list").on("click", ".js-item-edit", (event) => {
//     //console log the click itself
//     console.log("edit button clicked!");
//     //get t index of the item in store.items
//     const id = getItemIdFromElement(event.currentTarget);
//     // rename the list item using the function
//     //render updated shopping list
//   });
// };

//responsible for replacing the item name when a user types it in
...
// responsible for handling the input change, when user type submission and change the item name
